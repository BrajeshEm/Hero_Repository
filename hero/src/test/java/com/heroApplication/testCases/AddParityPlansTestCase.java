...
import com_heroApplication_pageObjects.AddCurvConfigurationPlansPage;
...
AddCurvConfigurationPlansPage ac = new AddCurvConfigurationPlansPage(driver);
...
driver.findElement(By.xpath("//input[@id='prityfileupload']")).sendKeys("C://Users//Brajesh Kumar//OneDrive//Desktop//testData//ParityPlansTemplate.xlsx");
