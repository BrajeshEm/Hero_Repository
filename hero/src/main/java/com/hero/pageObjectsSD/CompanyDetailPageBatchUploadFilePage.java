...
public class CompanyDetailPageBatchUploadFilePage {
/**
...
public CompanyDetailPageBatchUploadFilePage(WebDriver rdriver) {
...
adriver.Type(sComp6, eleName, timeOut,typeData);
}
