...
public FormsPlansPage(WebDriver rdriver) {
...
By clickOnForms = By.xpath("//a[contains(text(),'FORMS')]");
...
public void clickOnForms(String eleName, int timeOut) throws Exception {
adriver.click(clickOnForms,timeOut, eleName);
}
