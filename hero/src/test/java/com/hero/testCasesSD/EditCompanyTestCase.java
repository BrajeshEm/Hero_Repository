...
public class EditCompanyTestCase extends StartBrowser{
...
EditCompanyPage au = new EditCompanyPage(driver);
au.clickOnentryUW("UW", 5);
au.clickOnSearch("Search", 10);
au.setOnScomp("select", 10, "Comp1");
Thread.sleep(5000);
au.clickOnSearchIcon("Click", 10);
Thread.sleep(5000);
au.clickOnEditCompany("Company Name", 10);
