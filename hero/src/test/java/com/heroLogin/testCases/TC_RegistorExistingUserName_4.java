...
public class TC_RegistorExistingUserName_4 extends StartBrowser{
	 ...
	 *         1) Go to https://herouw.net//Forms/Index?cid=pP1wcnwLK2Q__s_&isghq=false
	           2) Click on Register Link after login button
	           3) Enter All Valid User details in input field of HPQ Registration Step
	           4) Click on Submit
	           5) Verify the Page Text after  Registration 
