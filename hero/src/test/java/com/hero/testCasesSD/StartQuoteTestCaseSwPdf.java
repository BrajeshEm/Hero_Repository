...
import com.hero.pageObjectsSD.StartQuotePageSwPdf;

public class StartQuoteTestCaseSwPdf extends StartBrowser{
...
StartQuotePageSwPdf au = new StartQuotePageSwPdf(driver);
au.clickOnentryUW("UW", 5);
au.clickOnentrySQ("Start Quote", 10);
au.setOnComp("Compname", 10,"COMP6");
au.setPeo("Fresh Peo", 10);
au.setUwType("Standard UW", 10);
au.setStatus("In forn collection", 10);
