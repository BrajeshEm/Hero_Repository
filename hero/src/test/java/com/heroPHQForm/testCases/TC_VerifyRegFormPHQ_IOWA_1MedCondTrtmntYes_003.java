...
public void VerifyRegForm1MedCondTrtmntYes_3() throws Exception {
	...
	reg.setMaritalStatus("Single",10);
	...
	reg.checkCoverageReq("Medical",10);
	reg.clickOnHethInsCoverageYes("Yes", 10);
	//driver.findElement(By.xpath("//body/div[@id='container']/div[6]/section[1]/form[1]/div[2]/div[2]/div[2]/div[1]/div[2]/input[1]")).click();
	//reg.clickOnSelectAllThatApply(" Employee ", 10);
	//reg.setNameOfCovPerson("Raghav", 10, "Name Of Covered Person");
	//reg.setInsCompNameAndAdd("Zoho", 10, "Insurance Name And Address");
	reg.clickOnNext(" Next ", 10);
	Thread.sleep(15000);

	/* Go to PHQ_Registration Step3 - Medical Conditions and Treatments */
	// Test Steps:-
	reg.clickOnMedConListYes("Yes", 5);
	reg.clickOnMedConListNo("No", 5);
	//reg.clickOnMedConListtYes("Yes", 5);
	//reg.clickOnMedConListtNo("No", 5);
	reg.clickOnNext(" Next ", 10);
	Thread.sleep(6000);

	/* Go to PHQ_Registration Step4 - Check Condition Details and Medications */
	// Arthritis--
//	reg.setConditionDiagnosis("Conition", 10, "Condition/Diagnosis");
//	reg.setBackDisDateOnsett("03/02/2021", 10, "Date of onset");
//	reg.selBackDisLastDatTreatedd("03/15/2021", 10, "Last date treated");
//	reg.setTrtmentDrugCond1("cod1", 10);
//	reg.setConditionDiagnosiss("Conition1", 10, "Condition/Diagnosis");
//	reg.setBackDisDateOnsettt("03/02/2021", 10, "Date of onset");
//	reg.selBackDisLastDatTreateddd("03/15/2021", 10, "Last date treated");
//	reg.setTrtmentDrugCond2("cod2", 10);
	reg.clickOnNext(" Next ", 10);
	Thread.sleep(6000);
//	driver.findElement(By.xpath("//tbody/tr[@id='row_0']/td[6]/span[1]/span[1]/span[1]/ul[1]/li[1]")).click();
//	Thread.sleep(5000);
//	driver.findElement(By.xpath("//tbody/tr[@id='row_1']/td[6]")).click();
