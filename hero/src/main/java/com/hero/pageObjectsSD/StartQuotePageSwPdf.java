...
public class StartQuotePageSwPdf {
/**
...
public StartQuotePageSwPdf(WebDriver rdriver) {
...
By status = By.xpath("//option[contains(text(),'In Form Collection')]");
By usingPhqs = By.xpath("//input[@id='isUsingPHQ']");
By usingPhqType = By.xpath("//input[@id='PDF']");
...
public void clickOnSave(String eleName, int timeout) throws Exception {
	WebElement ele = driver.findElement(By.xpath("//body/div[@id='container']/div[7]/section[1]/form[1]/div[2]/div[1]/input[1]"));
	getUtil.acrollIntoView(ele, driver);
