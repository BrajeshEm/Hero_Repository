...
public void VerifyRegForm1MedCondTrtmntYes_3() throws Exception {
	...
	reg.clickOnMedConListYes("NO", 5);
	reg.clickOnMedConListYes1("NO", 5);
	reg.clickOnNext(" Next ", 10);
...
//		reg.setCurHosCond("Medium", 10, "Condition/Diagnosis");
//		reg.setCurHosOnset("08/01/2020", 10, "Date of onset");
//		reg.setCurHosTreated("08/07/2020", 10, "Last date treated");
//		reg.setCurHosStillTaking("Yes", 10);
//		reg.setCurHosDegRcvry("1", 10, "Degree of recovery");
//		;
//		
//		/// Other Condition - Currently Confined
//		reg.setCurConCond("Medium", 10, "Condition/Diagnosis");
//		reg.setCurConOnset("08/01/2020", 10, "Date of onset");
//		reg.setCurConTreated("08/07/2020", 10, "Last date treated");
//		reg.setCurConStillTaking("Yes", 10);
//		reg.setCurConDegRcvry("1", 10, "Degree of recovery");
//		
//		
//		/// Other Condition - Currently Counseling
//				reg.setCurConsConsd("Medium", 10, "Condition/Diagnosis");
//				reg.setCurConsOnset("08/01/2020", 10, "Date of onset");
//				reg.setCurConsTreated("08/07/2020", 10, "Last date treated");
//				reg.setCurConsStillTaking("Yes", 10);
//				reg.setCurConsDegRcvry("1", 10, "Degree of recovery");
//				
//				
//				/// Other Condition - Condition not on Phq
//				reg.setConNotConsd("Medium", 10, "Condition/Diagnosis");
//				reg.setConNotOnset("08/01/2020", 10, "Date of onset");
//				reg.setConNotTreated("08/07/2020", 10, "Last date treated");
//				reg.setConNotStillTaking("Yes", 10);
//				reg.setConNotDegRcvry("1", 10, "Degree of recovery");
//				
//				
//				/// Other Condition - Circulatory system
//				reg.setCirSysConsd("Medium", 10, "Condition/Diagnosis");
//				reg.setCirSysOnset("08/01/2020", 10, "Date of onset");
//				reg.setCirSysTreated("08/07/2020", 10, "Last date treated");
//				reg.setCirSysStillTaking("Yes", 10);
//				reg.setCirSysDegRcvry("1", 10, "Degree of recovery");
//				
//				
//				/// Other Condition - Breast
//				reg.setBreConsd("Medium", 10, "Condition/Diagnosis");
//				reg.setBreOnset("08/01/2020", 10, "Date of onset");
//				reg.setBreTreated("08/07/2020", 10, "Last date treated");
//				reg.setBreStillTaking("Yes", 10);
//				reg.setBreDegRcvry("1", 10, "Degree of recovery");
//				
//				
//				/// Other Condition - Bowel
//				reg.setBowConsd("Medium", 10, "Condition/Diagnosis");
//				reg.setBowOnset("08/01/2020", 10, "Date of onset");
//				reg.setBowTreated("08/07/2020", 10, "Last date treated");
//				reg.setBowStillTaking("Yes", 10);
//				reg.setBowDegRcvry("1", 10, "Degree of recovery");
//				
//				
//				/// Other Condition - Bone and Joint
//				reg.setBoneConsd("Medium", 10, "Condition/Diagnosis");
//				reg.setBoneOnset("08/01/2020", 10, "Date of onset");
//				reg.setBoneTreated("08/07/2020", 10, "Last date treated");
//				reg.setBoneStillTaking("Yes", 10);
//				reg.setBoneDegRcvry("1", 10, "Degree of recovery");
//			
//				
//				/// Other Condition - Birth defect
//				reg.setBirthConsd("Medium", 10, "Condition/Diagnosis");
//				reg.setBirthOnset("08/01/2020", 10, "Date of onset");
//				reg.setBirthTreated("08/07/2020", 10, "Last date treated");
//				reg.setBirthStillTaking("Yes", 10);
//				reg.setBirthDegRcvry("1", 10, "Degree of recovery");
//				
//				
//				/// Other Condition - Aids Hiv
//				reg.setAidsConsd("Medium", 10, "Condition/Diagnosis");
//				reg.setAidsOnset("08/01/2020", 10, "Date of onset");
//				reg.setAidsTreated("08/07/2020", 10, "Last date treated");
//				reg.setAidsStillTaking("Yes", 10);
//				reg.setAidsDegRcvry("1", 10, "Degree of recovery");
				reg.clickOnNext(" Next ", 10);
				Thread.sleep(3000);
