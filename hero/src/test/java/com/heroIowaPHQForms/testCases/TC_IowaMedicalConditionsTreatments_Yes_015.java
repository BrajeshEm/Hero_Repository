package com.heroIowaPHQForms.testCases;
...
import com.hero.pageObjects.IOWAPageObject;
...
public class TC_IowaMedicalConditionsTreatments_Yes_015 extends StartBrowser{
	 ...
	 ***/
@Test
public void verifyRegUsingYesStep_3() throws Exception {
	...
	IOWAPageObject iowaReg = new IOWAPageObject(driver);
	...
	// Test Steps:-
//	reg.setSSN("123456789", 20, "SSN");      //-------now disabled (may be Bug)
	reg.setGender("F", 20);
	...
	iowaReg.clickOnCoverageReqLink("Medical", 5);
	iowaReg.clickOnPreviousCoverageLink("Yes", 5);
	iowaReg.clickOnSelectAllThatAppLink("Employee", 5);
	iowaReg.selOnNameOfCoveredPerson("Shiv", 5, "Name of covered person");
	iowaReg.selOnIncuranceComNameAdd("Add123", 5, "Insurance cimpany name");
	reg.clickOnNext(" Next ", 10);
	...
	// Test Steps:-
	iowaReg.clickOnAidsHivLink("Aids/Hiv", 5);
	iowaReg.clickOnInOutPatient("No", 5);
	
	reg.clickOnNext(" Next ", 10);

	/* Go to PHQ_Registration Step4 - Check Condition Details and Medications */
	StartBrowser.test = StartBrowser.test
			.createNode(" Go to PHQ_Registration Step4 - Check Condition Details and Medications  ");
//	// Arthritis--
