...
public class PHQ_arizona_registerPage {
	...
	By clickOnMedConListNo1 =  By.xpath("//body/div[@id='container']/div[6]/section[1]/form[1]/div[3]/div[31]/div/div[2]/input[2]");
	By clickOnMedConListNo =   By.xpath("//body/div[@id='container']/div[6]/section[1]/form[1]/div[3]/div/div[1]/input[2]");
	...
	//---> if no
		...
		{
			adriver.clickAndScroll(clickOnMedConListNo1, textMedConListNoYes, redBtn);
		}
		

		public void clickOnMedConListNo(String redBtn, int timeout) throws Exception // sel yes
		{
