...
public class EditCompanyPageHeroRx {
/**
...
public EditCompanyPageHeroRx(WebDriver rdriver) {
...
By save = By.xpath("//input[@id='btnAllResultSave']");
...
adriver.Type(sComp1, eleName, timeOut,typeData);
}
...
adriver.click(editC, timeout, eleName);
}
