...
public class EditPeoPage {
	...
	public  EditPeoPage(WebDriver rdriver) {
	...
	By SearchPeoBtn    = By.xpath("//input[@placeholder='Search']");
	By searchIcon      = By.xpath("//a[@class='imageSearchItem']");
	...
	getUtil get = new getUtil(driver);
	    ...
	    public void clickOnSearchPeoBtn(String typeData, String eleName, int timeout) throws Exception {
			...
			adriver.click(searchIcon, timeout, eleName);
		}
